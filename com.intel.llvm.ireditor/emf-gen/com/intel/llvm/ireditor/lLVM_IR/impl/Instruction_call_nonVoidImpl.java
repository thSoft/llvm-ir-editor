 ...
 * <ul>
 *   <li>{@link com.intel.llvm.ireditor.lLVM_IR.impl.Instruction_call_nonVoidImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class Instruction_call_nonVoidImpl extends Instruction_callImpl implements Instruction_call_nonVoid
{
	/**
	...
	{
		return LLVM_IRPackage.eINSTANCE.getInstruction_call_nonVoid();
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__NAME:
				return getName();
			case LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__TYPE:
				return getType();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == LocalValue.class)
		{
			...
			{
				case LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__NAME: return LLVM_IRPackage.LOCAL_VALUE__NAME;
				default: return -1;
			}
		}
		...
		if (baseClass == NamedMiddleInstruction.class)
		{
			switch (derivedFeatureID)
			{
				default: return -1;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == LocalValue.class)
		{
			...
			{
				case LLVM_IRPackage.LOCAL_VALUE__NAME: return LLVM_IRPackage.INSTRUCTION_CALL_NON_VOID__NAME;
				default: return -1;
			}
		}
		if (baseClass == NamedInstruction.class)
