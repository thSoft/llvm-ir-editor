...
public class LLVM_IRSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case LLVM_IRPackage.NAMED_INSTRUCTION:
			{
				...
				if (result == null) result = caseInstruction(namedInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.NAMED_MIDDLE_INSTRUCTION:
			{
				...
				if (result == null) result = caseMiddleInstruction(namedMiddleInstruction);
				if (result == null) result = caseLocalValue(namedMiddleInstruction);
				if (result == null) result = caseInstruction(namedMiddleInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.NAMED_TERMINATOR_INSTRUCTION:
			{
				...
				if (result == null) result = caseTerminatorInstruction(namedTerminatorInstruction);
				if (result == null) result = caseLocalValue(namedTerminatorInstruction);
				if (result == null) result = caseInstruction(namedTerminatorInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_RET:
			{
				...
				if (result == null) result = caseInstruction(instruction_ret);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_BR:
			{
				...
				if (result == null) result = caseInstruction(instruction_br);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_SWITCH:
			{
				...
				if (result == null) result = caseInstruction(instruction_switch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_INDIRECTBR:
			{
				...
				if (result == null) result = caseInstruction(instruction_indirectbr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.INSTRUCTION_RESUME:
			{
				...
				if (result == null) result = caseInstruction(instruction_resume);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_UNREACHABLE:
			{
				...
				if (result == null) result = caseInstruction(instruction_unreachable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.BINARY_INSTRUCTION:
			{
				...
				if (result == null) result = caseNamedInstruction(binaryInstruction);
				if (result == null) result = caseMiddleInstruction(binaryInstruction);
				if (result == null) result = caseLocalValue(binaryInstruction);
				if (result == null) result = caseInstruction(binaryInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_ADD:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_add);
				if (result == null) result = caseNamedInstruction(instruction_add);
				if (result == null) result = caseMiddleInstruction(instruction_add);
				if (result == null) result = caseLocalValue(instruction_add);
				if (result == null) result = caseInstruction(instruction_add);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FADD:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_fadd);
				if (result == null) result = caseNamedInstruction(instruction_fadd);
				if (result == null) result = caseMiddleInstruction(instruction_fadd);
				if (result == null) result = caseLocalValue(instruction_fadd);
				if (result == null) result = caseInstruction(instruction_fadd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.INSTRUCTION_SUB:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_sub);
				if (result == null) result = caseNamedInstruction(instruction_sub);
				if (result == null) result = caseMiddleInstruction(instruction_sub);
				if (result == null) result = caseLocalValue(instruction_sub);
				if (result == null) result = caseInstruction(instruction_sub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FSUB:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_fsub);
				if (result == null) result = caseNamedInstruction(instruction_fsub);
				if (result == null) result = caseMiddleInstruction(instruction_fsub);
				if (result == null) result = caseLocalValue(instruction_fsub);
				if (result == null) result = caseInstruction(instruction_fsub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_MUL:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_mul);
				if (result == null) result = caseNamedInstruction(instruction_mul);
				if (result == null) result = caseMiddleInstruction(instruction_mul);
				if (result == null) result = caseLocalValue(instruction_mul);
				if (result == null) result = caseInstruction(instruction_mul);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FMUL:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_fmul);
				if (result == null) result = caseNamedInstruction(instruction_fmul);
				if (result == null) result = caseMiddleInstruction(instruction_fmul);
				if (result == null) result = caseLocalValue(instruction_fmul);
				if (result == null) result = caseInstruction(instruction_fmul);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_UDIV:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_udiv);
				if (result == null) result = caseNamedInstruction(instruction_udiv);
				if (result == null) result = caseMiddleInstruction(instruction_udiv);
				if (result == null) result = caseLocalValue(instruction_udiv);
				if (result == null) result = caseInstruction(instruction_udiv);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_SDIV:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_sdiv);
				if (result == null) result = caseNamedInstruction(instruction_sdiv);
				if (result == null) result = caseMiddleInstruction(instruction_sdiv);
				if (result == null) result = caseLocalValue(instruction_sdiv);
				if (result == null) result = caseInstruction(instruction_sdiv);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FDIV:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_fdiv);
				if (result == null) result = caseNamedInstruction(instruction_fdiv);
				if (result == null) result = caseMiddleInstruction(instruction_fdiv);
				if (result == null) result = caseLocalValue(instruction_fdiv);
				if (result == null) result = caseInstruction(instruction_fdiv);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_UREM:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_urem);
				if (result == null) result = caseNamedInstruction(instruction_urem);
				if (result == null) result = caseMiddleInstruction(instruction_urem);
				if (result == null) result = caseLocalValue(instruction_urem);
				if (result == null) result = caseInstruction(instruction_urem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_SREM:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_srem);
				if (result == null) result = caseNamedInstruction(instruction_srem);
				if (result == null) result = caseMiddleInstruction(instruction_srem);
				if (result == null) result = caseLocalValue(instruction_srem);
				if (result == null) result = caseInstruction(instruction_srem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FREM:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_frem);
				if (result == null) result = caseNamedInstruction(instruction_frem);
				if (result == null) result = caseMiddleInstruction(instruction_frem);
				if (result == null) result = caseLocalValue(instruction_frem);
				if (result == null) result = caseInstruction(instruction_frem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.BITWISE_BINARY_INSTRUCTION:
			{
				...
				if (result == null) result = caseLocalValue(bitwiseBinaryInstruction);
				if (result == null) result = caseInstruction(bitwiseBinaryInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_SHL:
			{
				...
				if (result == null) result = caseLocalValue(instruction_shl);
				if (result == null) result = caseInstruction(instruction_shl);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_LSHR:
			{
				...
				if (result == null) result = caseLocalValue(instruction_lshr);
				if (result == null) result = caseInstruction(instruction_lshr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_ASHR:
			{
				...
				if (result == null) result = caseLocalValue(instruction_ashr);
				if (result == null) result = caseInstruction(instruction_ashr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_AND:
			{
				...
				if (result == null) result = caseLocalValue(instruction_and);
				if (result == null) result = caseInstruction(instruction_and);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_OR:
			{
				...
				if (result == null) result = caseLocalValue(instruction_or);
				if (result == null) result = caseInstruction(instruction_or);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_XOR:
			{
				...
				if (result == null) result = caseLocalValue(instruction_xor);
				if (result == null) result = caseInstruction(instruction_xor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.INSTRUCTION_EXTRACTELEMENT:
			{
				...
				if (result == null) result = caseLocalValue(instruction_extractelement);
				if (result == null) result = caseInstruction(instruction_extractelement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_INSERTELEMENT:
			{
				...
				if (result == null) result = caseLocalValue(instruction_insertelement);
				if (result == null) result = caseInstruction(instruction_insertelement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_SHUFFLEVECTOR:
			{
				...
				if (result == null) result = caseLocalValue(instruction_shufflevector);
				if (result == null) result = caseInstruction(instruction_shufflevector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.AGGREGATE_INSTRUCTION:
			{
				...
				if (result == null) result = caseNamedInstruction(aggregateInstruction);
				if (result == null) result = caseMiddleInstruction(aggregateInstruction);
				if (result == null) result = caseLocalValue(aggregateInstruction);
				if (result == null) result = caseInstruction(aggregateInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_EXTRACTVALUE:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_extractvalue);
				if (result == null) result = caseNamedInstruction(instruction_extractvalue);
				if (result == null) result = caseMiddleInstruction(instruction_extractvalue);
				if (result == null) result = caseLocalValue(instruction_extractvalue);
				if (result == null) result = caseInstruction(instruction_extractvalue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_INSERTVALUE:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_insertvalue);
				if (result == null) result = caseNamedInstruction(instruction_insertvalue);
				if (result == null) result = caseMiddleInstruction(instruction_insertvalue);
				if (result == null) result = caseLocalValue(instruction_insertvalue);
				if (result == null) result = caseInstruction(instruction_insertvalue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_ALLOCA:
			{
				...
				if (result == null) result = caseNamedInstruction(instruction_alloca);
				if (result == null) result = caseMiddleInstruction(instruction_alloca);
				if (result == null) result = caseLocalValue(instruction_alloca);
				if (result == null) result = caseInstruction(instruction_alloca);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_LOAD:
			{
				...
				if (result == null) result = caseNamedInstruction(instruction_load);
				if (result == null) result = caseMiddleInstruction(instruction_load);
				if (result == null) result = caseLocalValue(instruction_load);
				if (result == null) result = caseInstruction(instruction_load);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_STORE:
			{
				...
				if (result == null) result = caseInstruction(instruction_store);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FENCE:
			{
				...
				if (result == null) result = caseInstruction(instruction_fence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_CMPXCHG:
			{
				...
				if (result == null) result = caseNamedInstruction(instruction_cmpxchg);
				if (result == null) result = caseMiddleInstruction(instruction_cmpxchg);
				if (result == null) result = caseLocalValue(instruction_cmpxchg);
				if (result == null) result = caseInstruction(instruction_cmpxchg);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_ATOMICRMW:
			{
				...
				if (result == null) result = caseNamedInstruction(instruction_atomicrmw);
				if (result == null) result = caseMiddleInstruction(instruction_atomicrmw);
				if (result == null) result = caseLocalValue(instruction_atomicrmw);
				if (result == null) result = caseInstruction(instruction_atomicrmw);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_GETELEMENTPTR:
			{
				...
				if (result == null) result = caseNamedInstruction(instruction_getelementptr);
				if (result == null) result = caseMiddleInstruction(instruction_getelementptr);
				if (result == null) result = caseLocalValue(instruction_getelementptr);
				if (result == null) result = caseInstruction(instruction_getelementptr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.CONVERSION_INSTRUCTION:
			{
				...
				if (result == null) result = caseNamedInstruction(conversionInstruction);
				if (result == null) result = caseMiddleInstruction(conversionInstruction);
				if (result == null) result = caseLocalValue(conversionInstruction);
				if (result == null) result = caseInstruction(conversionInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.OTHER_INSTRUCTION:
			{
				...
				if (result == null) result = caseNamedInstruction(otherInstruction);
				if (result == null) result = caseMiddleInstruction(otherInstruction);
				if (result == null) result = caseLocalValue(otherInstruction);
				if (result == null) result = caseInstruction(otherInstruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_ICMP:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_icmp);
				if (result == null) result = caseNamedInstruction(instruction_icmp);
				if (result == null) result = caseMiddleInstruction(instruction_icmp);
				if (result == null) result = caseLocalValue(instruction_icmp);
				if (result == null) result = caseInstruction(instruction_icmp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_FCMP:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_fcmp);
				if (result == null) result = caseNamedInstruction(instruction_fcmp);
				if (result == null) result = caseMiddleInstruction(instruction_fcmp);
				if (result == null) result = caseLocalValue(instruction_fcmp);
				if (result == null) result = caseInstruction(instruction_fcmp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_PHI:
			{
				...
				if (result == null) result = caseNamedInstruction(instruction_phi);
				if (result == null) result = caseLocalValue(instruction_phi);
				if (result == null) result = caseInstruction(instruction_phi);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_SELECT:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_select);
				if (result == null) result = caseNamedInstruction(instruction_select);
				if (result == null) result = caseMiddleInstruction(instruction_select);
				if (result == null) result = caseLocalValue(instruction_select);
				if (result == null) result = caseInstruction(instruction_select);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LLVM_IRPackage.INSTRUCTION_VA_ARG:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_va_arg);
				if (result == null) result = caseNamedInstruction(instruction_va_arg);
				if (result == null) result = caseMiddleInstruction(instruction_va_arg);
				if (result == null) result = caseLocalValue(instruction_va_arg);
				if (result == null) result = caseInstruction(instruction_va_arg);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LLVM_IRPackage.INSTRUCTION_LANDINGPAD:
			{
				...
				if (result == null) result = caseNamedMiddleInstruction(instruction_landingpad);
				if (result == null) result = caseNamedInstruction(instruction_landingpad);
				if (result == null) result = caseMiddleInstruction(instruction_landingpad);
				if (result == null) result = caseLocalValue(instruction_landingpad);
				if (result == null) result = caseInstruction(instruction_landingpad);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			{
				GlobalValueRefConstant globalValueRefConstant = (GlobalValueRefConstant)theEObject;
				T result = caseGlobalValueRefConstant(globalValueRefConstant);
				if (result == null) result = caseConstant(globalValueRefConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Global Value Ref Constant</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Global Value Ref Constant</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGlobalValueRefConstant(GlobalValueRefConstant object)
	{
		return null;
	}
